...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
            ...
            <div class="body">
                <form class="form-horizontal" id="form_validation" method="POST" action="{{ route('supplier.store') }}">
                    {{ csrf_field() }}
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('supplier_name') ? 'error' : ''}}">
                                    <input type="text" name="supplier_name" class="form-control" placeholder="e.g: First Supplier" value="{{ old('supplier_name') }}" required>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('supplier_email') ? 'error' : ''}}">
                                    <input type="email" name="supplier_email" class="form-control" placeholder="e.g: email@gmail.com" value="{{ old('supplier_email') }}" required>
                                </div>
                                @if($errors->has('supplier_name'))
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('supplier_phone') ? 'error' : ''}}">
                                    <input type="number" name="supplier_phone" class="form-control" placeholder="e.g: 021745232" value="{{ old('supplier_phone') }}" required>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('supplier_address') ? 'error' : ''}}">
                                    <textarea name="supplier_address" class="form-control" placeholder="e.g: Jl. Jalan Yuk Kita" required>{{ old('supplier_address')}}</textarea>
                                </div>
