                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('order_number') ? 'error' : ''}}">
                                    <input type="text" name="order_number" class="form-control" placeholder="Auto Generate" value="{{ old('order_number') }}" required>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('order_date') ? 'error' : ''}}">
                                    <input type="text" name="order_date" class="datepicker form-control" placeholder="DD/MM/YYYY" value="{{ old('order_date') }}" required>
                                </div>
                                        ...
                                        <td>
                                            <div class="form-group {{ $errors->has('order_detail[1][item_id]') ? 'error' : '' }}">
                                                <select name="order_detail[1][item_id]" class="form-control" style="width: 100%;">
                                                    ...
                                                    <option value="{{ $key->id }}">{{ $key->item_name }} / {{ $key->item_unit }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group {{ $errors->has('order_status') ? 'error' : ''}}">
                                <select name="order_status" class="form-control show-tick" data-live-search="true">
                                    ...
                                    <option value="DRAFT" {{ old('order_status') == 'DRAFT' ? 'selected="selected"' : '' }}>DRAFT</option>
                                    <option value="ISSUED" {{ old('order_status') == 'ISSUED' ? 'selected="selected"' : '' }}>ISSUED</option>
                                </select>
