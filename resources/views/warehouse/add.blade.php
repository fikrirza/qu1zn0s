...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
            ...
            <div class="body">
                <form class="form-horizontal" id="form_validation" method="POST" action="{{ route('warehouse.store') }}">
                    {{ csrf_field() }}
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('warehouse_name') ? 'error' : ''}}">
                                    <input type="text" name="warehouse_name" class="form-control" placeholder="e.g: First Warehouse" value="{{ old('warehouse_name') }}" required>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('address') ? 'error' : ''}}">
                                    <textarea name="address" class="form-control" placeholder="e.g: Jl. Jalan Yuk Kita" required>{{ old('address')}}</textarea>
                                </div>
